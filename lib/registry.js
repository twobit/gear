...
var Registry = exports.Registry = function Registry(options) {
    ...
    // Load gear-lib if present
    if(gearlib) this._loadDir(gearlib);
...
console.log('resolved: '+path.resolve('node_modules', name, 'lib'));
